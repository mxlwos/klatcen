...
function test_form(form) {
	let errors = 0;
	form.querySelectorAll("input, textarea").forEach(function(tempInput) {
		if(tempInput.getAttribute("required") == "true") {
			if(tempInput.getAttribute("name") == "email") {
				if(email_test(tempInput)) {
					errors++;
					tempInput.classList.add("_error");
				} else {
					tempInput.classList.remove("_error");
				}
	...
	if(errors == 0) {
		form.querySelector(".form__submit").removeAttribute("disabled");
		return true;
	} else {
